...
const Navbar = () => {
  const { currency, setCurrency, availableCoins, addCoin } =
  ...
  const renderSearchBar = () => {
    ...
    return <h2 className="text-decoration-none navbar-brand">Coin Info</h2>;
  };
              ...
              return (
                <li key={vs_currency}>
                  <button
                    ...
                    type="button"
                    onClick={() => handleListItemClick(vs_currency, symbol)}
                  >
                    {symbol}-{full_name}
                  </button>
                </li>
