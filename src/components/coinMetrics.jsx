...
const CoinMetrics = ({ coin, currency }) => {
  ...
  const prettifyNumbers = (metric, metric_name = null) => {
    if (metric) {
      try {
        if (
          ["current_price", "high_24h", "low_24h", "price_change_24h"].find(
          ...
          ["price_change_percentage_24h"].find((name) => name === metric_name)
        ) {
  ...
  const renderMetrics = () => {
    ...
    return (
      <div
        className="d-flex flex-row justify-content-around align-items-center mt-2 mb-5 pb-1
                            shadow-sm bg-white"
      >
        <div className="d-flex flex-column justify-content-around align-items-center">
          <div className="d-flex flex-column justify-content-between align-items-center">
            ...
            <span className="mx-1 my-1 fs-3">
              {currency?.symbol}
              {prettifyNumbers(coinData?.current_price, "current_price")}
            </span>
          </div>
          <div className="d-flex flex-column justify-content-between align-items-center">
            ...
            <span className="mx-1 my-1 fs-3">
              {currency?.symbol}
              {prettifyNumbers(coinData?.high_24h, "high_24h")}
            </span>
          </div>
          <div className="d-flex flex-column justify-content-between align-items-center">
            ...
            <span className="mx-1 my-1 fs-3">
              {currency?.symbol}
              {prettifyNumbers(coinData?.low_24h, "low_24h")}
            </span>
          </div>
        </div>
        <div className="d-flex flex-column justify-content-around align-items-center">
          ...
          <div className="d-flex flex-column justify-content-between align-items-center">
            ...
            <span className="mx-1 my-1 fs-3">
              {prettifyNumbers(coinData?.market_cap_rank, "market_cap_rank")}
            </span>
          </div>
          <div className="d-flex flex-column justify-content-between align-items-center">
            <span className="mx-1 my-1 fs-6">Total Volume</span>
            <span className="mx-1 my-1 fs-3">
              {prettifyNumbers(coinData?.total_volume, "total_volume")}
            </span>
          </div>
        </div>
        <div className="d-flex flex-column justify-content-around align-items-center">
          ...
          <div className="d-flex flex-column justify-content-between align-items-center">
            ...
            <span className="mx-1 my-1 fs-3">
              {prettifyNumbers(coinData?.total_supply, "total_supply")}
            </span>
          </div>
        </div>
      </div>
